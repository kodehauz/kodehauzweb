...
function Footer() {
  return (
    <div className='bg-white w-full px-5 md:px-0'>
      <div className='flex flex-col justify-content items-center mx-auto w-full md:w-[65%] space-y-8 text-black py-10'>
        <div className='flex items-center space-x-2'>
          <KodeLogo width={50} height={50} />
          <h1 className='text-pri font-bold text-3xl'>KodeHauz</h1>
        </div>
        <p className='text-gray-500 text-center text-sm'>
          Discover how KodeHauz Solutions Planet can revolutionize your business
          with forward-thinking technology solutions. Contact us today for a
          professional consultation and lets embark on a journey towards digital
          transformation and success together.
        </p>
